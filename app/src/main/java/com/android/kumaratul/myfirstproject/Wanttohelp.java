package com.android.kumaratul.myfirstproject;
...
public class Wanttohelp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wanttohelp);
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                android.support.v4.app.NotificationCompat.Builder builder=new NotificationCompat.Builder(getApplication()).setSmallIcon(R.drawable.pic1)
                        .setContentTitle("HOPE").setContentText("WE ARE VERY GLAD YOU HELPED SOMEONE,PLEASE VISIT AGAIN !!");
        ...
        b4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                android.support.v4.app.NotificationCompat.Builder builder=new NotificationCompat.Builder(getApplication()).setSmallIcon(R.drawable.pic1)
                        .setContentTitle("HOPE").setContentText("SORRY FOR THE INCONVENIENCE.RESPONDING YOU WITHIN 24 HRS");
                Intent i=new Intent(getApplicationContext(),MainActivity.class);
                PendingIntent contentIntent=PendingIntent.getActivity(getApplicationContext(),0,i,PendingIntent.FLAG_UPDATE_CURRENT);
                builder.setContentIntent(contentIntent);
                NotificationManager manager=(NotificationManager)getSystemService(Context.NOTIFICATION_SERVICE);
